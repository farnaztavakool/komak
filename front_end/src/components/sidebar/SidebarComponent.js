                ...
                >
                    ...
                    <Column className={css(styles.menuItemList)}>
                        <MenuItemComponent
                            title="News"
                            icon={IconOverview}
                            onClick={() => onItemClicked('News')}
                            active={selectedItem === 'News'}
                        />
                        <MenuItemComponent
                            title="Map"
                            icon={IconTickets}
                            onClick={() => onItemClicked('Map')}
                            active={selectedItem === 'Map'}
                        />
                        <MenuItemComponent
                            title="Safety Advice"
                            icon={IconIdeas}
                            onClick={() => onItemClicked('Safety Advice')}
                            active={selectedItem === 'Safety Advice'}
                        />
                        <MenuItemComponent
                            title="Mental Health"
                            icon={IconContacts}
                            onClick={() => onItemClicked('Mental Health')}
                            active={selectedItem === 'Mental Health'}
                        />
                        {/* <MenuItemComponent
                            title=""
                            icon={IconAgents}
                        ...
                        <MenuItemComponent
                            ...
                            onClick={() => onItemClicked('Donation')}
                            active={selectedItem === 'Donation'}
                        />
                    </Column>
                </Column>
                {isMobile && expanded && (
